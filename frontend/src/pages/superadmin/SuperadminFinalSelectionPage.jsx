...
import { Home, Video, Target, GraduationCap, BarChart2, CheckCircle, XCircle, ClipboardList, ArrowLeft } from 'lucide-react';
                    ...
                    <div className="container">
                        <div className="page-header">
                            ...
                            <div className="header-actions">
                                ...
                                >
                                    <ClipboardList size={18} style={{ marginRight: 8 }} /> View All Decisions
                                </button>
                                <button
                                            ...
                                            <React.Fragment key={student.studentId}>
                                                ...
                                                >
                                                    ...
                                                    <td
                                                        ...
                                                        onClick={(e) => {
                                                            e.stopPropagation();
                                                            navigate(`/superadmin/student-profile/${student.studentId}`);
                                                        }}
                                                        ...
                                                        <td colSpan="7">
                                                            <div className="details-panel">
                                                                ...
                                                                <div className="journey-section">
                                                                    <h4><ClipboardList size={16} style={{ marginRight: 5, verticalAlign: 'middle' }} /> Student Status</h4>
                                                                ...
                                                                <div className="journey-section">
                                                                    <h4><Home size={16} style={{ marginRight: 5, verticalAlign: 'middle' }} /> Physical Verification (PV)</h4>
                                                                    <div className="detail-grid">
                                                                        <div className="detail-item">
                                                                ...
                                                                <div className="journey-section">
                                                                    <h4><Video size={16} style={{ marginRight: 5, verticalAlign: 'middle' }} /> Virtual Interview (VI)</h4>
                                                                    <div className="detail-grid">
                                                                        <div className="detail-item">
                                                                ...
                                                                {/* Real Interview */}
                                                                <div className="journey-section">
                                                                    <h4><Target size={16} style={{ marginRight: 5, verticalAlign: 'middle' }} /> Real Interview (RI)</h4>
                                                                    <div className="detail-grid">
                                                                        <div className="detail-item">
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div className="form-section">
                                            ...
                                            <div className="decision-buttons">
                                                ...
                                                >
                                                    <CheckCircle size={20} style={{ marginRight: 8 }} /> SELECT for Scholarship
                                                </button>
                                                <button
                                                    className={`decision-option rejected-option ${decision === 'REJECTED' ? 'active' : ''}`}
                                                    onClick={() => setDecision('REJECTED')}
                                                >
                                                    <XCircle size={20} style={{ marginRight: 8 }} /> REJECT for Scholarship
                                                </button>
                                            </div>
                                        </div>
