...
const VIInterviewFormPage = () => {
    ...
    return (
        <div className="vi-dashboard-layout"> {/* Generic class for VI Dashboard Layout */}
            ...
            <main className="main-content">
                <div className="vi-interview-form-page-content">
                    <div className="page-header-row">
                        <h2>Virtual Interview - Student Review</h2>
                        <button
                            className="back-btn"
                            onClick={() => navigate('/vi/assigned')}
                        >
