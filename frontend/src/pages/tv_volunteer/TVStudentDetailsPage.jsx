        ...
        <div className="admin-layout animate-fadeIn">
            ...
            <nav className="side-nav">
                ...
                <div className="nav-links">
                    <button className="nav-item" onClick={() => navigate('/tv/students')}>
                        <span className="icon"><Home size={18} /></span> Overview
                    </button>
                    <button className="nav-item active" onClick={() => { }}>
                        <span className="icon"><FileText size={18} /></span> Student Details
                    </button>
                </div>
            ...
            <main className="main-content">
                <div className="page-header">
                    <div className="header-title">Student Details</div>
                </div>
